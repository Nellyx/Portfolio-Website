        ...
        <div className="left-text">
          <div className="left-margin">
            ...
            <p className="main">
              ...
              as the concepts and practices of web app development and
              maintenance
            </p>
            <p className="main">
        ...
        <div className="right-text">
          <div className="right-margin">
            <div className="my-skills">
              ...
              <p className="main">
                I possess all the skills and experiences your looking for to
                build a high-end solid and scalable front-end products with
                great user experiences. I have built products for small
                companies and start ups around the globe ranging from marketing
                to complex solution enterprises.
              </p>
